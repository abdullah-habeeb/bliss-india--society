        ...
        {heroConfig.ctaText && (
          <a
            ...
            onClick={(e) => {
              ...
              if (heroConfig.ctaTargetId.startsWith('http')) {
            ...
            target={heroConfig.ctaTargetId?.startsWith('http') ? "_blank" : undefined}
            rel={heroConfig.ctaTargetId?.startsWith('http') ? "noopener noreferrer" : undefined}
            style={{
              fontFamily: 'Inter, system-ui, sans-serif',
              fontSize: '11px',
              fontWeight: 600,
